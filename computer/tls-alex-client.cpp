...
void *writerThread(void *conn)
{
	...
	{
		char ch;
		printf("Command (w=forward, j,W, s=reverse,k,S, a=turn left , A, d=turn right, D,u= ultrasonic, i=colour, r=release,e=grab, m=medpack x=stop, c=clear stats, g=get stats q=exit)\n");
		...
		switch(ch)
		{
			...
			case 'D':
					buffer[1] = 'R';
                                        ...
                                        sendData(conn, buffer, sizeof(buffer));
                                        break;
			case 'i': // get coloursensor values
      					buffer[1] = 'h';
      					params[0] = 0;
      					params[1] = 0;
      					memcpy(&buffer[2], params, sizeof(params));
